...
def add_cafe():
    ...
    if form.validate_on_submit():
        print("True")
        row = [form.cafe.data, form.location.data, form.opening_time.data, form.closing_time.data, form.coffee_rating.data, form.wifi_rating.data, form.power_rating.data]
